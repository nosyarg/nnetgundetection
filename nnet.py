...
classes = 3
new_data = genfromtxt('compresseddata.csv',delimiter=',').transpose()
new_target = genfromtxt('target.csv',delimiter=',')
...
for i in range (0,5000):#run for 5000 epochs
    ...
    NetworkWriter.writeToFile(fnn,'storage.xml')
